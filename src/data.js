...
export const products = [
  {
    ...
    category: "Makanan",
    description:
      "Bolu kelapa dengan cita rasa klasik yang selalu bikin rindu. Memiliki tekstur yang padat namun lembut, dengan serutan kelapa parut asli yang memberikan rasa gurih manis di setiap gigitan. Cocok untuk teman minum teh hangat. (Produksi: Ibu Sukini)",
    images: [boluKelapa],
    location: "Bentar",
  ...
  },
  {
    ...
    category: "Makanan",
    description:
      "Opak singkong 'Romeo' yang tipis dan super renyah. Dibuat dari singkong pilihan yang ditumbuk halus dan dibumbui dengan pas. Camilan ringan yang tidak bikin kenyang, tapi bikin ketagihan. (Produksi: Ibu Sukini)",
    images: [opakSingkong],
    location: "Bentar",
    whatsapp: "6285786474699",
  },
  {
    ...
    category: "Makanan",
    description:
      "Inovasi camilan dari bakso daging yang diiris tipis dan digoreng garing hingga menjadi keripik. Sensasi rasa daging sapi yang kuat berpadu dengan tekstur kriuk yang unik. (Produksi: Ibu Lastri)",
    images: [kripikBakso],
    location: "Bendo",
  ...
  },
  {
    ...
    category: "Makanan",
    description:
      "Keripik pisang dengan potongan yang pas, tidak terlalu tebal dan tidak terlalu tipis. Digoreng dengan kematangan yang tepat sehingga warnanya kuning cerah dan rasanya manis alami pisang. (Produksi: Ibu Muryanti)",
  ...
  },
  {
    ...
    description:
      "Rempeyek renyah dengan toping kacang tanah pilihan. Gurih, renyah, dan aroma daun jeruknya terasa pas. (Produksi: Ibu Muryanti/Tini)",
    images: [peyekKacang],
    location: "Perampelan II",
    whatsapp: "6285700232558",
  },
  {
    ...
    category: "Makanan",
    description:
      "Keripik singkong original yang renyah tanpa pengawet. Menggunakan bumbu bawang ketumbar yang sederhana namun nendang. Teman setia saat santai atau nonton TV. (Produksi: Ibu Tini)",
  ...
  },
  {
    ...
    category: "Makanan",
    description:
      "Rempeyek dengan taburan kacang tanah yang melimpah dan irisan daun jeruk yang wangi. Adonan tepungnya tipis dan super renyah, tidak berminyak berlebihan. (Produksi: Ibu Tini)",
