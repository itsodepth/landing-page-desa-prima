  ...
  return (
    <div className="container mx-auto px-6 md:px-12 py-8">
      ...
      <div className="w-full h-64 md:h-120 bg-gray-300 rounded-lg overflow-hidden mb-8 relative">
        ...
        <button
          onClick={handlePrev}
          className="absolute left-4 top-1/2 -translate-y-1/2 text-4xl text-white bg-black/30 hover:bg-black/50 rounded-full w-10 h-10 flex items-center justify-center"
        >
          ‹
        </button>
        <button
          onClick={handleNext}
          className="absolute right-4 top-1/2 -translate-y-1/2 text-4xl text-white bg-black/30 hover:bg-black/50 rounded-full w-10 h-10 flex items-center justify-center"
        >
          ›
        </button>
