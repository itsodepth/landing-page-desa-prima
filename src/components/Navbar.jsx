...
const Navbar = () => {
    ...
    // Sembunyikan navbar saat scroll ke bawah, munculkan lagi saat scroll ke atas
    useEffect(() => {
        const handleScroll = () => {
    ...
    return (
        <nav className={`sticky top-0 z-50 bg-[#5D866C] text-[#F5F5F5] py-4 px-6 md:px-12 transition-transform duration-300 ${hiddenOnScroll ? "-translate-y-full" : "translate-y-0"}`}>
            <div className="container mx-auto flex justify-between items-center">
                {/* Logo Kiri */}
                <div className="font-bold text-xl bg-[#F5F5F5] text-[#5D866C] px-3 py-1 rounded">Logo UMKM</div>
                ...
                <ul className="hidden md:flex space-x-24 text-md font-medium">
                    ...
                    <li className="hover:text-gray-200 cursor-pointer">Tentang Kami</li>
                </ul>
