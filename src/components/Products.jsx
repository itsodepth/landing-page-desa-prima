...
const DUSUN_OPTIONS = ["Geblug", "Bendo", "Bentar", "Cerme", "Kenteng", "Perampelan I", "Perampelan II", "Klumpit", "Sumberan"];
...
const Products = () => {
    ...
    const filteredProducts = useMemo(
        () =>
            products.filter((item) => {
                ...
                const matchDusun = selectedDusun.length === 0 || selectedDusun.includes(item.location);
    ...
    return (
        <div id="products-section" className="container mx-auto px-6 md:px-12 py-12">
            ...
            <div className="mb-4 flex justify-between items-center md:hidden">
                ...
                <button type="button" onClick={() => setShowFilters((prev) => !prev)} className="text-sm px-3 py-1 border border-gray-300 rounded-full hover:bg-gray-100">
                ...
                <div className={`w-full md:w-1/4 mb-4 md:mb-0 ${showFilters ? "block" : "hidden md:block"}`}>
                    <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-4 md:p-5 space-y-6">
                        ...
                        <div className="border-t border-gray-100 pt-4">
                            <h3 className="font-semibold text-sm text-gray-800 mb-3 flex items-center justify-between">
                                <span>Dusun</span>
                                <span className="text-[11px] uppercase tracking-wide text-gray-400">Lokasi UMKM</span>
                            </h3>
